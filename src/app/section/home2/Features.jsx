...
const features = [
  ...
  },
  {
    ...
    image: "/assets/images/resource/features-h2-1.jpg",
  },
  {
    id: 3,
    number: "#03",
...
export default function FeaturesSectionTwo() {
  ...
  const activeImage = features.find(f => f.id === activeIndex)?.image;
          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              {/* <figure className="image mb-0">
                <img src="/assets/images/resource/project1-1.jpg" alt=""/>
              </figure> */}
            </div>
