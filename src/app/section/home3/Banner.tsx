...
const slides = [
  {
    id: 1,
    bg: "/assets/images/background/banner-h3-1.jpg",
  },
  {
    id: 2,
    bg: "/assets/images/background/banner-h3-2.jpg",
  },
  {
    id: 3,
    bg: "/assets/images/background/banner-h3-3.jpg",
  },
];
  ...
  return (
    <section className="banner-section-three">
                    ...
                    <div className="content-box">
                      ...
                      <div className="bottom-box">
                        <div className="banner-icon">
                          <img
                            src="/assets/images/icons/banner-h3-icon1.png"
                            alt="icon"/>
                        </div>
      ...
      <ul className="banner-social-link">
        ...
        <li>
          <Link href="#"><i className="fa-regular fa-x"></i></Link>
        </li>
        <li>
