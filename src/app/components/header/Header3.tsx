            ...
            <div className="outer-box">
                ...
                <div className="header-lower">
                    <div className="auto-container">
                        <div className="inner-lower px-0">
                            <div className="main-box">
                                ...
                                <div className="action-box">
                                    ...
                                    onClick={handleOpen}>
                                    <i className="icon fa-solid fa-bars-staggered"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
