        ...
        <div className="row">
          <div className="outer-box col-lg-5">
            <figure className="image">
              <img src="/assets/images/resource/features-h3-1.jpg" alt="Design Process" />
            </figure>
            <div className="sec-title-style-three text-left">
              ...
              <h2 className="title text-reveal-anim">
                Our Step-by-Step Approach To <br /> Exceptional Design
              </h2>
              <div className="text">
              ...
              <Link href="/page-contact" className="theme-btn btn-style-two">
                ...
                <span className="icon"><i className="fa-light fa-arrow-right"></i></span>
              </Link>
            </div>
          </div>
