...
const awardsData = [
  {
    year: "2026",
    image: "/assets/images/resource/award-3-1.png",
  ...
  {
    year: "2025",
    image: "/assets/images/resource/award-3-2.png",
  ...
  {
    year: "2023",
    image: "/assets/images/resource/award-3-3.png",
        ...
        <div className="sec-title-style-two">
          <div className="row w-100">
            ...
            <h2 className="title text-reveal-anim col-xl-7 offset-xl-3">
              Our Most Prestigious Awards And <br /> Industry Honors
            </h2>
          </div>
        </div>
