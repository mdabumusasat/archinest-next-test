        ...
        <div className="row">
            ...
            <div className="inner-column">
                ...
                <div className="author-info">
                  <div className="inner-box">
                    ...
                    <div className="info">
                      <img
                        className="image"
                        src="/assets/images/resource/author2.png"
                        alt="sign"
                      />
                      <h6>
                        <Link href="/page-about">Founder of Archinest</Link>
                      </h6>
                    </div>
                  </div>
                </div>
              ...
              <div className="video-box">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url(/assets/images/background/video1-1.jpg)",
                  }}>
                  <a
                    className="play-now"
          ...
          <div className="image-column col-xl-5 col-lg-6 offset-xl-1">
            <div className="inner-column">
              ...
              <Link href="/page-project-details" className="theme-btn btn-style-one">
