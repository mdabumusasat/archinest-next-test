      ...
      <div className="auto-container">
        ...
        <div className="row mb-5">
          <div className="col-lg-4 col-md-6">
            <img
              className="img-fluid"
              src="/assets/images/resource/project-details-1.jpg"
              alt="project"
            />
          </div>
          <div className="col-lg-8 col-md-6">
            <img
              className="img-fluid"
              src="/assets/images/resource/project-details-2.jpg"
              alt="project"
            />
          </div>
        </div>
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6">
            ...
            <div className="mb-4">
              ...
              <p>Sed ut perspiciatis unde omnis natus voluptatem accusantium doloremque laudantium, totam rem aperiam inventore</p>
            </div>
            <div>
        ...
        <div className="row mt-5">
          <div className="col-md-6">
            <img
              className="img-fluid"
              src="/assets/images/resource/project-details-3.jpg"
              alt="project"
            />
          </div>
          <div className="col-md-6">
            <img
              className="img-fluid"
              src="/assets/images/resource/project-details-4.jpg"
              alt="project"/>
          </div>
        </div>
        <div className="row">
